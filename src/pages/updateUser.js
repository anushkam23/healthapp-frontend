...
//         fetch("https://healthapp-backend-5huq.onrender.com/updateUser", {
//             method: "POST",
//             crossDomain: true,
//             headers: {
...
//         try {
//             const response = await fetch("https://healthapp-backend-5huq.onrender.com/updateUser", {
//                 method: "POST",
//                 crossDomain: true,
//                 headers: {
//                     "Content-Type": "application/json",
  ...
  return (
    <div className="auth-wrapper">
      <div className="auth-inner">
        ...
        Email
        <br />
        <input placeholder="Email" className="form-control" value={email} disabled /> <br />
        <button onClick={updateData}>Update Details</button>
      </div>
    </div>
  );
