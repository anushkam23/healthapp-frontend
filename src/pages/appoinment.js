...
// const getPdf=async()=>{
//   const result=await axios.get("https://healthapp-backend-5huq.onrender.com/get-files");
...
//     try {
//       const result = await axios.post('https://healthapp-backend-5huq.onrender.com/upload-files', formData, {
...
//   const showPdf=(pdf)=>{
//     window.open(`https://healthapp-backend-5huq.onrender.com/files/${pdf}`,"_blank","noreferrer");
//   }
...
function App() {
  ...
  const showPdf = () => {
    if (recentPdf) {
      window.open(`https://healthapp-backend-5huq.onrender.com/files/${recentPdf.pdf}`, "_blank", "noreferrer");
    }
  };
